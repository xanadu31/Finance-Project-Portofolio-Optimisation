...
plot(Routsample,u,col="red",type="l",xlim=c(0,0.00001),main= "Variance en fonction de la moyenne, sans méthode de nétoyage",xlab= "variance")
...
plot(Routsample,u,col="red",type="l", xlim=c(0,0.00001),main= "Variance en fonction de la moyenne, avec clipping",xlab= "variance")
lines(Rtrue,u,col="darkblue")
...
plot(RoutsampleShrink,u,col="black",type="l",xlim=c(0,0.00001),main= "Variance en fonction de la moyenne, avec shrinkage",xlab= "variance")
...
#plot final
plot(RoutsampleShrink,u,col="black",type="l",xlim=c(0,0.00001),main= "Variance en fonction de la moyenne, avec clipping et shrinkage",xlab= "variance")
lines(Routsample,u,col="red")
lines(Rtrue,u,col="darkblue")
lines(RoutsampleMP,u,col="brown")
lines(Routsampleclip,u,col="green")
legend("topleft",cex = 0.8, legend = c("Rtrue","Routsample","RoutsampleShrink", "Routsampleclip","RoutSampleLoiPuiss"), col = c("darkblue", "red","black","green","brown"), pch = "-", pt.cex = 1.5,  text.col = "forestgreen")
